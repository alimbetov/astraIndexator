...
class DocumentVersionLifecycle(Base):
    ...
    state: Mapped[str] = mapped_column(String(32), nullable=False, server_default=text("'BUILDING'"))
...
class LifecycleOperation(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("producer_request_id", name="uq_lifecycle_operation_producer_request_id"),
        Index("ix_lifecycle_operation_document", "document_id", "document_version", "created_at"),
        Index(
